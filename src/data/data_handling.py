from src import np, torch, Dataset, pd
...
class Scenario():
    ...
    def __init__(self, periods, problem_params, store_params, warehouse_params, echelon_params, num_samples, observation_params, seeds=None):
        ...
        self.procurement_costs = self.generate_data_for_samples_and_stores(
            problem_params, 
            store_params['procurement_cost'], 
            seeds['procurement_cost'], 
            discrete=False
        )
    ...
    def get_data(self):
        ...
        data =  {'demands': self.demands,
                ...
                'procurement_costs': self.procurement_costs,
