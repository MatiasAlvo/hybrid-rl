...
if len(sys.argv) == 4:
    ...
    print(f'Number of parameters should be either 4 or 2 (so that last 2 parameters are defined in main_run.py)')
    assert False
...
# Remove logging params from settings config if they exist
if 'logging_params' in config_setting:
    del config_setting['logging_params']
...
wrapper_params = {
    ...
    'ppo_params': optimizer_params.get('ppo_params', {})  # Pass PPO params from config
}
